                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              decoration: BoxDecoration(color:  AppColors.gray, borderRadius: const BorderRadius.all(Radius.circular(10))),
                                              child: Padding(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      ...
                                                      Container(
                                                        decoration:
                                                            BoxDecoration(color:  AppColors.gray, borderRadius: const BorderRadius.all(Radius.circular(5))),
                                                        child: Padding(
